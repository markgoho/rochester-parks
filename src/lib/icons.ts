...
export type StatusKind = Exclude<IconKind, 'rows' | 'cards'>;
...
/** Where one icon is in the sprite file. */
export function iconHref(kind: IconKind): string {
  return `/icons.svg#${kind}`;
}
